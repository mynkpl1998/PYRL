...
class DiscretePolicy(nn.Module):
	...
	# samples an action according to current policy
	...
	def get_kl(self, x):
		...
		kl = action_prob0 * (torch.log(action_prob0) - torch.log(action_prob1)) # kl divergence formula, * is element wise product
